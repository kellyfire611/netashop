          ...
          <div class="p-2 mt-4">
            <form name="frmRegister" method="post" class="needs-validation" novalidate
              ...
              <div class="mb-3">
                ...
                <div class="position-relative auth-pass-inputgroup">
                  <input type="password" class="form-control pe-5 password-input"
                    name="password"
                    onpaste="return false" placeholder="Enter password" id="password-input" aria-describedby="passwordInput" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="last_name" placeholder="Mời nhập họ" required name="last_name">
                <div class="invalid-feedback">
                  Mời nhập họ
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="first_name" placeholder="Mời nhập tên" required name="first_name">
                <div class="invalid-feedback">
                  Mời nhập tên
                </div>
              </div>
              ...
              <div class="mb-3">
                <label for="first_name" class="form-label">Giới tính <span class="text-danger">*</span></label>

                <div class="form-check mb-2">
                  <input class="form-check-input" type="radio" name="gender" id="gender_1" value="0">
                ...
                <div class="form-check mb-2">
                  <input class="form-check-input" type="radio" name="gender" id="gender_2" value="1">
              ...
              <div class="mb-4">
                <p class="mb-0 fs-12 text-muted fst-italic">Bằng cách đăng ký tài khoản trên hệ thống, bạn đã đồng ý các điều khoản theo cam kết sau <a href="#" class="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</a></p>
              </div>
